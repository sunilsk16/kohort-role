...
var NewMentorsComponent = /** @class */ (function () {
    ...
    NewMentorsComponent.prototype.ngOnInit = function () {
        ...
        this.iconTab = this.formBuilder.group({
            ...
            othersOne: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            othersTwo: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            othersThree: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            joinFrom: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            fileSource: [[], [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]],
            logoSource: [[], [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]],
        });
