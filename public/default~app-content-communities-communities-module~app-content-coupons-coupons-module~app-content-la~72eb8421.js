(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-content-communities-communities-module~app-content-coupons-coupons-module~app-content-la~72eb8421"],{
...
var MentorService = /** @class */ (function () {
    ...
    MentorService.prototype.addReview = function (data) {
        data.timeStamp = moment__WEBPACK_IMPORTED_MODULE_5__().format('x');
        return firebase_app__WEBPACK_IMPORTED_MODULE_3__["firestore"]().collection('reviews').add(data);
    };
    MentorService.prototype.updateReview = function (uid, data) {
        data.timeStamp = moment__WEBPACK_IMPORTED_MODULE_5__().format('x');
        return this.afs.doc('reviews/' + data.id).set(data);
    };
    MentorService.prototype.deleteReviewById = function (id) {
        return this.afs.doc('reviews/' + id).delete();
    };
    MentorService.prototype.getAllReview = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.firestore.collection('reviews').snapshotChanges()
                .subscribe(function (reviews) {
                var contactList = reviews.map(function (item) {
                    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, item.payload.doc.data()), { id: item.payload.doc.id });
                });
                resolve(contactList);
            });
    ...
    MentorService.prototype.getReviewById = function (id) {
        var _this = this;
        return new Promise(function (resolve) {
            var docRef = _this.firestore.collection("reviews").doc(id);
            docRef.ref.get().then(function (doc) {
                if (doc.exists) {
                    var res = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc.data()), { id: doc.id });
                    resolve(res);
    ...
    MentorService.prototype.getReviewBId = function (reviewsId) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.firestore.collection('reviews', function (ref) { return ref.where('reviewsId', '==', parseInt(reviewsId)); }).snapshotChanges()
                .subscribe(function (reviews) {
                var contactList = reviews.map(function (item) {
                    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, item.payload.doc.data()), { id: item.payload.doc.id });
                });
...
//# sourceMappingURL=default~app-content-communities-communities-module~app-content-coupons-coupons-module~app-content-la~72eb8421.js.map