...
@Component({
  ...
  templateUrl: './abrod-studies.component.html',
  styleUrls: ['./abrod-studies.component.css']
})
export class AbrodStudiesComponent implements OnInit {
  ...
  createStudies() {
    ...
    this.mentorsService.addStudies(data)
      .then(() => {
        ...
        this.alertService.showSuccess('Studies added successfully !!');
        this.iconTab.reset();
        this.imageList = [];
        this.router.navigate(['/studies/list']);
  ...
  updateStudies() {
    ...
    this.mentorsService.updateStudies(data.id, data)
      .then(() => {
        this.isLoading = false;
        this.alertService.showSuccess('Studies updated successfully !!')
        this.router.navigate(['/studies/list']);
      })
  }
